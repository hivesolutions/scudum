...
the root environment is created with:
    ...
    SCUDUM_ARCH=arm SCUDUM_VENDOR=rasp SCUDUM_SYSTEM=linux-gnueabi GCC_BUILD_ARCH=armv6zk GCC_BUILD_CPU=arm1176jzf-s GCC_BUILD_TUNE=arm1176jzf-s GCC_BUILD_FPU=vfp GCC_BUILD_FLOAT=hard scudum root
