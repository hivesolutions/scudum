if [ "$SCUDUM_CROSS" == "1" ]; then
    case "$SCUDUM_ARCH" in
        arm*)
            ...
            export CFLAGS="-O3 -I/usr/include -I/include -D__ARM_PCS_VFP -Wl,-rpath,/usr/lib -Wl,-rpath,/lib"
            export CXXFLAGS="-O3 -I/usr/include -I/include -D__ARM_PCS_VFP -Wl,-rpath,/usr/lib -Wl,-rpath,/lib"
