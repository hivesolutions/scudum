...
wget --content-disposition "http://downloads.sourceforge.net/bootinfoscript/bootinfoscript-$VERSION.tar.gz?use_mirror=netix" "--output-document=bootinfoscript-$VERSION.tar.gz"
