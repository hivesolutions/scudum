...
wget --content-disposition "http://downloads.sourceforge.net/gnu-efi/gnu-efi_$VERSION.orig.tar.gz?use_mirror=netix" "--output-document=gnu-efi_$VERSION.orig.tar.gz"
