...
wget --content-disposition "http://downloads.sourceforge.net/lxde/lxde-icon-theme-$VERSION.tar.xz?use_mirror=netix" "--output-document=lxde-icon-theme-$VERSION.tar.xz"
