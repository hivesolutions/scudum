...
wget --content-disposition "http://downloads.sourceforge.net/cdrtools/alpha/cdrtools-$VERSION.tar.gz?use_mirror=netix" "--output-document=cdrtools-$VERSION.tar.gz"
