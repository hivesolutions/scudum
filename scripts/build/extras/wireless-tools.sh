...
rget "https://mirrors.hive.pt/mirrors/scudum/wireless-tools/$VERSION/wireless_tools.$VERSION.tar.gz"\
    "http://ftp.lfs-matrix.net/pub/clfs/conglomeration/wireless_tools.$VERSION.tar.gz/wireless_tools.$VERSION.tar.gz"\
