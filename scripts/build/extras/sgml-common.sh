...
rget "ftp://sources.redhat.com/pub/docbook-tools/new-trials/SOURCES/sgml-common-$VERSION.tgz"\
...
wget --content-disposition "http://archive.hive.pt/files/lfs/patches/sgml-common-$VERSION-manpage-1.patch"
