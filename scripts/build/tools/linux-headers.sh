...
rget "https://mirrors.hive.pt/mirrors/scudum/linux/$VERSION/linux-$VERSION.tar.xz"\
    "https://cdn.kernel.org/pub/linux/kernel/v$VERSION_L/linux-$VERSION.tar.xz"\
